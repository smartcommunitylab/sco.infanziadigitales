...
public class ImportData {
    ...
    public static List<KidProfile> readChildren(InputStream excel, String appId,
            RepositoryService storage) throws Exception {
        ...
        try {
            ...
            for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                String telGen = fmt.formatCellValue(
                ...
                KidProfile kidDb =
                        storage.getKidProfile(appId, schoolProfile.getSchoolId(), cfAlunno);
                if (kidDb != null) {
                    if (logger.isInfoEnabled()) {
