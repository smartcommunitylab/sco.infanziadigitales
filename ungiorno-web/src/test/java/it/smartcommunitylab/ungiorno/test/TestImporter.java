...
public class TestImporter {
	...
	public void testSchoolImport() throws ImportError {
		...
		importer.importSchoolData("a", "s", Thread.currentThread().getContextClassLoader().getResourceAsStream("model/scuola.xls"));
	...
	public void testChildrenImport() throws ImportError {
		Importer importer = new Importer();
		importer.importChildrenData("a", "s", Thread.currentThread().getContextClassLoader().getResourceAsStream("model/bambini.xls"));
